        ...
        nav.show-logo.nav-landing-c
          ...
          ul#menu.menu-hide
            ...
            li(data-menuanchor="home").active
              a(href="#home" alt="Go to Home").link.center_marker.fs-11.fw-500: span Home
            li(data-menuanchor="benefits")
              a(href="#benefits" alt="Go to Benefits").link.center_marker.fs-11.fw-500: span Benefits
            li(data-menuanchor="process")
              router-link(to="/process" alt="Go to Process").link.center_marker.fs-11.fw-500: span Process
            li
              .logo
                img(src="../../assets/img/icons/TanoiliLogo.svg")
            li(data-menuanchor="contact")
              router-link(to="/products" alt="Go to Process").link.center_marker.fs-11.fw-500: span Products
            li(data-menuanchor="about")
              router-link(to="/about" alt="Go to About").link.center_marker.fs-11.fw-500: span About Us
            li(data-menuanchor="contact")
              router-link(to="/contact" alt="Go to Contact").link.center_marker.fs-11.fw-500: span Contact
        .dropdown_language
          span.dropdown_define.fs-11.ct-primary(@click.stop="handleClickLang") ENG
            i
          ...
          ul.dropdown_menu
            ...
            li.dropdown_menu-item: a(href="https://tanoili.com" alt="Español").fs-11.ct-light ESP
...
<script>
  ...
  methods: {
    ...
    removeScrollClass() {
      setTimeout(() => { this.$el.classList.remove("scroll") }, 400)
    },
    handleClickLang() {
